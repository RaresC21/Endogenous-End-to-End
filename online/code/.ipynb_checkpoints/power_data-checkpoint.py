...
if __name__ == '__main__':
    ...
    robustness_levels = [0.6, 0.5, 0.3, 0.2, 0.15, 0.1]
    for power, robustness in zip(powers, robustness_levels):
        robust_rewards = []
        robust_rewards_nn = []
        kernel_rewards = []
        baseline_rewards = []
        ...
        for _ in tqdm(range(n_trials)): 
            ...
            robust_action_index, _ = robust_action(actions_train, demands_train, action_set, test_feature, 0.1)
    ...
    plt.plot(powers, robust_rewards_all, label = 'robust', color = 'blue')
